...
27.10.14 --- 15.11.14
	...
	б)Реализация итоговой суммы покупок = пункт ИТОГО (подсчет суммы цен со всех полей).
	Реализация Нового Списка (Пока полное очищение всех полей).
...
16.11.14 --- 23.11.14
	...
	Доделывание несделанного предыдущего задания.
